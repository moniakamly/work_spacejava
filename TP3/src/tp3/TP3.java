...
public class TP3 {
	...
	/**
	 * Vérifie si les élements d'un tableau sont dans l'ordre croissant
	 */
	public static void exercicet1() {
		...
		while (i < t.length - 1 && trie) {
			if (t[i] > t[i + 1]) {
				trie = false;
				System.out.println("Les élements du tableau ne sont pas dans l'ordre croissant");
			}
			i++;
		}
		if (trie) {
			System.out.println("Les élements du tableau sont dans l'ordre croissant");
		}
	}
	...
	/**
	 * Calcul d'un nombre binaire dans une chaine de caractères en sa valeur
	 * décimale
	 */
	...
	public static void exercice2prime() {
		...
		System.out.println("La valeur décimale est " + res);
	}

	/**
	 * Changer les lettres miniscules en Majuscules dans une chaine de caractères
	 */
	...
	/**
	 * Alternance de Majuscules et miniscules dans une chaine de caractères
	 */
	...
	/**
	 * Calcul du nombre d'occurences du caractères dans la chaine de caractère
	 */
	...
	/**
	 * Afficher une chaine de caractères lue après avoir oté de la chaine toutes les
	 * occurences du caractère c
	 */
